        ...
        <div class="flex items-center justify-center">
            <div class="w-full lg:w-1/2 my-6 pr-0 lg:pr-2">
                <p class="text-xl pb-6 flex items-center">
                    <i class="fas fa-user mr-3"></i>Add Trainer 
                </p>
                <div class="leading-loose">
                    ...
                    enctype="multipart/form-data">@csrf
                        ...
                        <div class="mt-2">
                            <label class="block text-sm text-gray-600" for="speciality">Speciality</label>
                            <input class="w-full px-5  py-1 text-gray-700 bg-gray-200 rounded" id="speciality" name="speciality" type="text" required="" placeholder="Your speciality" aria-label="speciality">
                        </div>
                        <div class="mt-2">
                        ...
                        <div class="mt-2">
                            ...
                            <input class="w-full px-5  py-1 text-gray-700 bg-gray-200 rounded" id="role" name="role" type="role" placeholder="trainer" aria-label="role" value="1" readonly>
                        </div>
                        ...
                        <div class="mt-6">
                            <button class="px-4 py-1 text-white font-light tracking-wider bg-gray-900 rounded" type="submit">Add Trainer</button>
                        </div>
                    </form>
                </div>
            </div>
